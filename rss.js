...
function RSS (options, items) {
    ...
    this.item = function (options) {
        ...
        var item = {
            ...
            date:            options.date,
            enclosureUrl:    options.enclosureUrl,
            enclosureLength: options.enclosureLength,
            enclosureType:   options.enclosureType
        };
...
function generateXML (data){
    ...
    data.items.forEach(function(item) {
        ...
        ifTruePush(item.enclosureUrl || item.enclosureLength || item.enclosureType, item_values,
          { enclosure: [ { _attr:
            { url: item.enclosureUrl, length: item.enclosureLength, type: item.enclosureType } } ] });
